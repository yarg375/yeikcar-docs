...
### <CustomIcon name="account-plus-outline">Account Creation</CustomIcon>
...
### <CustomIcon name="car-outline">Vehicle Setup</CustomIcon>
...
### <CustomIcon name="cog-outline">Preference Customization</CustomIcon>
